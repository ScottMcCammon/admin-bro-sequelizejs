...
describe('Resource', function () {
    ...
    describe('#update', () => {
        ...
        it('calls update hooks', async function () {
            ...
            chai_1.expect(beforeBulkUpdateSpy).to.have.been.called;
        });
    });
    describe('#delete', () => {
        beforeEach(async function () {
        ...
        it('calls delete hooks', async function () {
            ...
            await resource.delete(this.record.id);
            chai_1.expect(beforeDestroySpy).not.to.have.been.called;
            chai_1.expect(afterDestroySpy).not.to.have.been.called;
            chai_1.expect(beforeDestroyUpdateSpy).to.have.been.called;
        });
    });
});
